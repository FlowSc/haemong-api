-- ===================================
-- Complete Database Setup for Haemong API
-- ===================================
...
DO $$
BEGIN
  RAISE NOTICE 'Haemong API database setup completed successfully!';
  RAISE NOTICE 'Tables created: users, chat_rooms, messages';
  RAISE NOTICE 'Bot settings: 4 personality combinations (male/female + eastern/western)';
