-- =====================================================
-- Simple Complete Database Schema
-- All tables created from scratch without dependencies
-- =====================================================
...
-- =====================================================
-- 2. Bot Settings Table (No dependencies)
-- =====================================================
...
-- =====================================================
-- 3. Chat Rooms Table (Depends on users, bot_settings)
-- =====================================================
...
-- =====================================================
-- 4. Messages Table (Partitioned - depends on chat_rooms)
-- =====================================================
...
-- =====================================================
-- 5. Videos Table (Depends on users, chat_rooms)
-- =====================================================
CREATE TABLE videos (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
...
FROM pg_tables t WHERE t.tablename LIKE 'messages_%' AND t.schemaname = 'public'
ORDER BY pg_total_relation_size('public.'||t.tablename) DESC;

CREATE VIEW index_usage_stats AS
SELECT s.schemaname, s.relname as tablename, s.indexrelname as indexname, s.idx_scan, s.idx_tup_read
FROM pg_stat_user_indexes s
WHERE s.relname LIKE 'messages%' OR s.relname IN ('chat_rooms', 'users', 'videos')
