...
export const getEnvironmentConfig = (
  ...
  return {
    ...
    rateLimit: {
      short: {
        ...
        limit: configService.get<number>(
          ...
          getDefaultRateLimit(nodeEnv, 'short'),
        ),
      },
      medium: {
        ...
        limit: configService.get<number>(
          ...
          getDefaultRateLimit(nodeEnv, 'medium'),
        ),
      },
      long: {
        ...
        limit: configService.get<number>(
          ...
          getDefaultRateLimit(nodeEnv, 'long'),
        ),
      },
    },
    ...
    features: {
      enableImageGeneration: configService.get<boolean>(
        'ENABLE_IMAGE_GENERATION',
        true,
      ),
      enableVideoGeneration: configService.get<boolean>(
        'ENABLE_VIDEO_GENERATION',
        true,
      ),
      enablePremiumFeatures: configService.get<boolean>(
